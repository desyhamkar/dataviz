...
3. mutate -- membuat kolom /memodifikasi kolom yang sudah ada
4.group by -- memngelompokkan berdasarkan bulan (pada contoh diatas)
5. summaries -- melakukan perhitungan rata-rata
